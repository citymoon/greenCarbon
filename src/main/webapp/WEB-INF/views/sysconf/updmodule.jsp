                ...
                <div class="ibox-content">
					  ...
					  <div class="form-group">
					    <div class="col-sm-4 col-sm-offset-2">
			              <button class="btn btn-primary" type="submit" id="conSub"><i class="fa fa-save"></i>保存</button>
			              <button class="btn btn-primary radius" onclick="javascript:history.back(-1);"><i class="fa fa-reply"></i>返回</button>
			            </div>
					  </div>
				  </form>
	           </div>
...
<script src="${ctx}/resources/js/demo/layer-demo.js"></script>
