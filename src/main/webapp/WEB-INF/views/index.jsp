...
<link href="${ctx}/resources/static/h-ui.admin/css/H-ui.login.css" rel="stylesheet" type="text/css" />
...
<![endif]-->
<title>GreenCarbon-Admin-Login</title>
<meta name="keywords" content="GreenCarbon,admin">
<meta name="description" content="GreenCarbon,admin">
</head>
<body>
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="loginto" method="POST">
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60d;</i></label>
        <div class="formControls col-xs-8">
          <input id="" name="userId" value="${model.userId }" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input id="" name="password" value="${model.password }" type="password" placeholder="密码" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
